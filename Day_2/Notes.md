...
- **Design file:** [mul2.v](./mul2.v)  
- **Netlist file:** [mul2_netlist.v](./mul2_netlist.v)
...
- **Design file:** [mult8.v](./mult8.v)  
- **Netlist file:** [mult8_netlist.v](./mult8_netlist.v)

---

**Key Takeaways:**  
- Multiplying by powers of 2 → **shift operation, zero hardware cost**.  
- Multiplying by constants like 9 → **shift + add**, which is much more efficient than using a generic multiplier.  

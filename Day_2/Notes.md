...
**Example:**  
Hierarchical synthesis netlist for [multiple_modules.v](./verilog_files/multiple_modules.v):

<img src="./images/hierarchical_synth_1.png">
...
**Example:**  
Flat synthesis netlist for [multiple_modules.v](./verilog_files/multiple_modules.v):

<img src="./images/flatten_synth_1.png">
...
- **Waveform** for [dff_syncres.v](./verilog_files/dff_syncres.v):

<img src="./images/dff_syncres_output.png">
...
- **Waveform** for [dff_async_set.v](./verilog_files/dff_async_set.v):

<img src="./images/dff_async_set.png">
...
- **Waveform** for [dff_asyncres.v](./verilog_files/dff_asyncres.v):

<img src="./images/dff_asyncres_output.png">
...
- **Gate-level netlist** for [mul2.v](./verilog_files/mul2.v)  
  <img src = "./images/mul_2.png" width = 600>
...
- **gate-level netlist** for [mult8.v](./verilog_files/mult8.v)  
  <img src="./images/mul_8.png" width = 600>
